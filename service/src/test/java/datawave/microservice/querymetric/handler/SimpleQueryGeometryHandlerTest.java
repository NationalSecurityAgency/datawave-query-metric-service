...
public class SimpleQueryGeometryHandlerTest {
    ...
    public void validQueryJexlTest() {
        ...
        Assertions.assertEquals(1, resp.getResult().size());
        Assertions.assertNull(resp.getExceptions());
        
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[0.0,0.0]}", queryGeometry.getGeometry());
        Assertions.assertEquals("geowave:contains(field1, 'POINT(0 0)')", queryGeometry.getFunction());
    }
    ...
    public void validGeoQueryJexlTest() {
        ...
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Polygon\",\"coordinates\":[[[0.0,0.0],[10,0.0],[10,10],[0.0,10],[0.0,0.0]]]}", queryGeometry.getGeometry());
        Assertions.assertEquals("geo:within_bounding_box(field1, '0_0', '10_10')", queryGeometry.getFunction());
    }
    ...
    public void validQueryLuceneTest() {
        ...
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[1,1]}", queryGeometry.getGeometry());
        Assertions.assertEquals("#COVERS(field2, 'POINT(1 1)')", queryGeometry.getFunction());
    }
    ...
    public void validGeoBoxQueryLuceneTest() {
        ...
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Polygon\",\"coordinates\":[[[0.0,0.0],[10,0.0],[10,10],[0.0,10],[0.0,0.0]]]}", queryGeometry.getGeometry());
        Assertions.assertEquals("#GEO(bounding_box, field1, '0_0', '10_10')", queryGeometry.getFunction());
    }
    ...
    public void validGeoCircleQueryLuceneTest() {
        ...
        Assertions.assertEquals("#GEO(circle, field1, '0_0', 10)", queryGeometry.getFunction());
    }
    ...
    public void validJexlQueryUndefinedSyntaxTest() {
        ...
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[2,2]}", queryGeometry.getGeometry());
        Assertions.assertEquals("geowave:covered_by(field3, 'POINT(2 2)')", queryGeometry.getFunction());
    }
    ...
    public void validLuceneQueryUndefinedSyntaxTest() {
        ...
        Assertions.assertEquals(0, resp.getResult().size());
        Assertions.assertEquals(1, resp.getExceptions().size());
        
        QueryExceptionType queryExceptionType = resp.getExceptions().get(0);
        Assertions.assertEquals("Unable to parse the geo features", queryExceptionType.getMessage());
    }
    ...
    public void validMultiFunctionQueryJexlTest() {
        ...
        Assertions.assertEquals(2, resp.getResult().size());
        Assertions.assertNull(resp.getExceptions());
        
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[4,4]}", queryGeometry.getGeometry());
        Assertions.assertEquals("geowave:intersects(field5, 'POINT(4 4)')", queryGeometry.getFunction());
        
        queryGeometry = resp.getResult().get(1);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[5,5]}", queryGeometry.getGeometry());
        Assertions.assertEquals("geowave:overlaps(field6, 'POINT(5 5)')", queryGeometry.getFunction());
    }
    ...
    public void validMultiFunctionQueryLuceneTest() {
        ...
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[6,6]}", queryGeometry.getGeometry());
        Assertions.assertEquals("#INTERSECTS(field7, 'POINT(6 6)')", queryGeometry.getFunction());
        
        queryGeometry = resp.getResult().get(1);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[7,7]}", queryGeometry.getGeometry());
        Assertions.assertEquals("#WITHIN(field8, 'POINT(7 7)')", queryGeometry.getFunction());
    }
    ...
    public void multipleQueryMetricsTest() {
        ...
        QueryGeometry queryGeometry = resp.getResult().get(0);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[1,1]}", queryGeometry.getGeometry());
        Assertions.assertEquals("#COVERS(field1, 'POINT(1 1)')", queryGeometry.getFunction());
        
        queryGeometry = resp.getResult().get(1);
        Assertions.assertEquals("{\"type\":\"Point\",\"coordinates\":[2,2]}", queryGeometry.getGeometry());
        Assertions.assertEquals("geowave:intersects(field2, 'POINT(2 2)')", queryGeometry.getFunction());
